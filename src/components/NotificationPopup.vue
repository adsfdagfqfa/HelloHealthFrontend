...
const getNotification = () => {
    ...
    axios.get("/spring/api/v1/toDoListService/notification/notices"+"?userId="+localStorage.getItem("userId"),{doNotShowLoadingScreen: true}).then((res) => {
...
const clearMessages = () => {
    messages.data = [];
    showingMessages.data = [];
    axios.delete("/spring/api/v1/toDoListService/notification/notices",{userId:localStorage.getItem("userId")},{doNotShowLoadingScreen: true})
}
</script>
